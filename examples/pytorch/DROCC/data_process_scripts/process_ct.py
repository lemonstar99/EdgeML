...
class CT_Dataset(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class):
        ...
        # train set
        #load data file path
        url1_train = 'data/ct/CharacterTrajectoriesDimension1_TRAIN.arff'
        url2_train = 'data/ct/CharacterTrajectoriesDimension2_TRAIN.arff'
        url3_train = 'data/ct/CharacterTrajectoriesDimension3_TRAIN.arff'
        ...
        # set up testing set
        url1_test = 'data/ct/CharacterTrajectoriesDimension1_TEST.arff'
        url2_test = 'data/ct/CharacterTrajectoriesDimension2_TEST.arff'
        url3_test = 'data/ct/CharacterTrajectoriesDimension3_TEST.arff'
...
def get_target(y, normal_class):
    ...
    for i in range(0, length):
        if y[i].decode('UTF-8') == '1':
            ...
            y_temp.append(9)
        elif y[i].decode('UTF-8') == '11':
            y_temp.append(10)
        elif y[i].decode('UTF-8') == '12':
            y_temp.append(11)
        elif y[i].decode('UTF-8') == '13':
            y_temp.append(12)
        elif y[i].decode('UTF-8') == '14':
            y_temp.append(13)
        elif y[i].decode('UTF-8') == '15':
            y_temp.append(14)
        elif y[i].decode('UTF-8') == '16':
            y_temp.append(15)
        elif y[i].decode('UTF-8') == '17':
            y_temp.append(16)
        elif y[i].decode('UTF-8') == '18':
            y_temp.append(17)
        elif y[i].decode('UTF-8') == '19':
            y_temp.append(18)
        elif y[i].decode('UTF-8') == '20':
            y_temp.append(19)
        idx.append(i)
